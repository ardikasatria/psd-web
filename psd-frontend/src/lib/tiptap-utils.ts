 ...
 */
async function validateImageFile(file: File, abortSignal?: AbortSignal) {
...
export const handleImageUpload = async (
  ...
  await validateImageFile(file, abortSignal)
...
export const createBlogImageUpload = (upload: (file: File) => Promise<{ url: string }>) => {
  return async (
    file: File,
    onProgress?: (event: { progress: number }) => void,
    abortSignal?: AbortSignal
