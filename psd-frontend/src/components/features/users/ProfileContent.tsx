        ...
        {profile.data && (
          ...
          >
            ...
            <div className="relative mb-0 hidden lg:block">
              ...
              <div className="pointer-events-none absolute inset-0 z-10 grid grid-cols-[minmax(0,280px)_1fr] gap-8">
                <div />
            ...
            <div className="lg:-mt-12 lg:grid lg:grid-cols-[minmax(0,280px)_1fr] lg:items-start lg:gap-8">
              <ProfileCard
