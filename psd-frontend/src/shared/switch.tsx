...
const colors = {
  ...
  primary: [
    '[--switch-bg-ring:var(--color-primary-700)]/90 [--switch-bg:var(--color-primary-600)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-primary-700)]/90 [--switch-shadow:var(--color-primary-900)]/20',
  ],
}
