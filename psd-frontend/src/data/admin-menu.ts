...
export const adminMenuItems: AdminMenuItem[] = [
  ...
  { name: 'Organisasi', href: '/admin/orgs', icon: BuildingOffice2Icon },
  ...
  { name: 'Moderasi laporan', href: '/admin/reports', icon: FlagIcon },
  { name: 'Tiket pengaduan', href: '/admin/support', icon: ChatBubbleLeftRightIcon },
