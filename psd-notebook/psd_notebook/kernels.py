"""Klien kernel server Jupyter — lifecycle via REST."""
from __future__ import annotations

import httpx

from psd_notebook.policy import check_can_start_kernel
...
async def start_kernel_gated(
    client: KernelClient, *, tier: str, running_count: int, name: str = "python3"
) -> dict:
