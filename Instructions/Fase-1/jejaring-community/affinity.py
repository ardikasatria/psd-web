"""
Saran "orang serupa" berbasis afiliasi (sesama institusi / sesama organisasi).

Cocok bila berbagi `org_id` (sama persis) ATAU `affiliation` (teks, case-insensitive).
Mengecualikan diri sendiri & yang sudah diikuti; urut popularitas lalu reputasi.
"""
...
def shares_affiliation(me: dict, other: dict) -> tuple[bool, str | None]:
    """(cocok?, alasan). Prioritaskan organisasi, lalu afiliasi institusi."""
...
def suggest_affiliation(me: dict, candidates: list[dict], *, following_ids=(),
