...
- `.env`: `GITEA_SSH_MODE=passthrough`, `GITEA_SSH_PORT=22`, **`GITEA_SSH_PUBLISH=127.0.0.1:2222:2222`**
- Gitea listen **:2222** di dalam kontainer (`SSH_LISTEN_PORT`); port **22** hanya untuk URL clone & host passthrough
